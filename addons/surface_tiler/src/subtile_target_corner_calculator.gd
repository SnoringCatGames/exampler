...
func get_target_top_left_corner(proximity: CellProximity) -> int:
    if !proximity.get_is_a_corner_match_subtile():
        ...
        if proximity.get_is_90_floor(0,-1) or \
                proximity.get_is_90_floor(-1,-1) or \
                proximity.get_is_top_right_corner_clipped_90_90(0,-1):
            if proximity.get_is_90_right_wall(-1,0) or \
                    proximity.get_is_90_right_wall(-1,-1) or \
                    proximity.get_is_bottom_left_corner_clipped_90_90(-1,0):
                ...
                if proximity.get_is_45_concave_cusp_at_left(-1,0):
                    ...
                    if proximity.get_is_45_neg_floor_at_left(1,-1):
                        if proximity.get_is_45_neg_ceiling_at_right(-1,1):
                            ...
                            return SubtileCorner.INT_90H_INT_45_H_SIDE
                    elif proximity.get_is_45_neg_ceiling_at_right(-1,1) or \
            ...
            if proximity.get_is_90_right_wall(-1,0) or \
                ...
                if proximity.get_is_45_concave_cusp_at_top(0,-1):
                    ...
                    if proximity.get_is_45_neg_floor_at_left(1,-1) or \
                ...
                if proximity.get_is_45_concave_cusp_at_top(0,-1):
                    ...
                    if proximity.get_is_top_left_corner_clipped_90_90(-1,-1):
                        if proximity.get_is_45_neg_floor_at_bottom(0,-2):
                            if proximity.get_is_45_neg_ceiling_at_right(-2,0):
                        ...
                        if proximity.get_is_top_left_corner_clipped_90V_45(-1,0):
                            if proximity.get_is_45_neg_floor_at_left(1,-1) or \
                                proximity.get_is_45_concave_cusp_at_top(0,-2):
                                if proximity.get_is_45_neg_ceiling_at_right(-1,1) or \
                                        proximity.get_is_45_concave_cusp_at_left(-2,0):
                                    return SubtileCorner.INT_INT_EXT_90H_45_CONCAVE_90V_45_CONCAVE_INT_45_FLOOR_45_CEILING
                                else:
                                    return SubtileCorner.INT_INT_EXT_90H_45_CONCAVE_90V_45_CONCAVE_INT_45_H_SIDE
                        ...
                        if proximity.get_is_45_neg_floor_at_left(0,-2) or \
                                proximity.get_is_45_neg_floor_at_top(2,0) or \
                                proximity.get_is_45_neg_floor(1,-1):
                            if proximity.get_is_45_neg_ceiling_at_top(-2,0) or \
                                    proximity.get_is_45_neg_ceiling_at_left(0,2) or \
                                    proximity.get_is_45_neg_ceiling(-1,1):
                                if proximity.get_is_top_right_corner_clipped_90H_45(0,-1):
                                    if proximity.get_is_bottom_left_corner_clipped_90V_45(-1,0):
...
func get_target_top_right_corner(proximity: CellProximity) -> int:
    if !proximity.get_is_a_corner_match_subtile():
        ...
        if proximity.get_is_90_floor(0,-1) or \
                proximity.get_is_90_floor(1,-1) or \
                proximity.get_is_top_left_corner_clipped_90_90(0,-1):
            if proximity.get_is_90_left_wall(1,0) or \
                    proximity.get_is_90_left_wall(1,-1) or \
                    proximity.get_is_bottom_right_corner_clipped_90_90(1,0):
                ...
                if proximity.get_is_45_concave_cusp_at_right(1,0):
                    ...
                    if proximity.get_is_45_pos_floor_at_right(-1,-1):
                        if proximity.get_is_45_pos_ceiling_at_left(1,1):
                            ...
                            return SubtileCorner.INT_90H_INT_45_H_SIDE
                    elif proximity.get_is_45_pos_ceiling_at_left(1,1) or \
            ...
            if proximity.get_is_90_left_wall(1,0) or \
                ...
                if proximity.get_is_45_concave_cusp_at_top(0,-1):
                    ...
                    if proximity.get_is_45_pos_floor_at_right(-1,-1) or \
                            proximity.get_is_45_concave_cusp_at_top(0,-2):
                        if proximity.get_is_45_pos_ceiling_at_left(1,1):
                            return SubtileCorner.INT_90V_INT_45_FLOOR_45_CEILING
                        else:
                ...
                if proximity.get_is_45_concave_cusp_at_top(0,-1):
                    ...
                    if proximity.get_is_top_right_corner_clipped_90_90(1,-1):
                        if proximity.get_is_45_pos_floor_at_bottom(0,-2):
                            if proximity.get_is_45_pos_ceiling_at_left(2,0):
                                return SubtileCorner.INT_90_90_CONCAVE_INT_45_FLOOR_45_CEILING
                            else:
                        ...
                        if proximity.get_is_top_right_corner_clipped_90V_45(1,0):
                            if proximity.get_is_45_pos_floor_at_right(-1,-1) or \
                                proximity.get_is_45_concave_cusp_at_top(0,-2):
                                if proximity.get_is_45_pos_ceiling_at_left(1,1) or \
                                        proximity.get_is_45_concave_cusp_at_right(2,0):
                                    return SubtileCorner.INT_INT_EXT_90H_45_CONCAVE_90V_45_CONCAVE_INT_45_FLOOR_45_CEILING
                                else:
                                    return SubtileCorner.INT_INT_EXT_90H_45_CONCAVE_90V_45_CONCAVE_INT_45_H_SIDE
                        ...
                        # All indirect neighbors in the directions of this corner are present.
                        if proximity.get_is_45_pos_floor_at_right(0,-2) or \
                                proximity.get_is_45_pos_floor_at_top(-2,0) or \
                                proximity.get_is_45_pos_floor(-1,-1):
                            if proximity.get_is_45_pos_ceiling_at_top(2,0) or \
                                    proximity.get_is_45_pos_ceiling_at_right(0,2) or \
                                    proximity.get_is_45_pos_ceiling(1,1):
                                if proximity.get_is_top_left_corner_clipped_90H_45(0,-1):
                                    if proximity.get_is_bottom_right_corner_clipped_90V_45(1,0):
                                        return SubtileCorner.INT_INT_90H_45_CONCAVE_90V_45_CONCAVE
                                    else:
...
func get_target_bottom_left_corner(proximity: CellProximity) -> int:
    if !proximity.get_is_a_corner_match_subtile():
        ...
        if proximity.get_is_90_ceiling(0,1) or \
                proximity.get_is_90_ceiling(-1,1) or \
                proximity.get_is_bottom_right_corner_clipped_90_90(0,1):
            if proximity.get_is_90_right_wall(-1,0) or \
                    proximity.get_is_90_right_wall(-1,1) or \
                    proximity.get_is_top_left_corner_clipped_90_90(-1,0):
                ...
                if proximity.get_is_45_concave_cusp_at_left(-1,0):
                    ...
                    if proximity.get_is_45_pos_ceiling_at_left(1,1):
                        if proximity.get_is_45_pos_floor_at_right(-1,-1):
                            ...
                            return SubtileCorner.INT_90H_INT_45_H_SIDE
                    elif proximity.get_is_45_pos_floor_at_right(-1,-1) or \
                        proximity.get_is_45_concave_cusp_at_left(-2,0):
                        return SubtileCorner.INT_90H_INT_45_V_SIDE
                    else:
                        return SubtileCorner.INT_90H
            ...
            if proximity.get_is_90_right_wall(-1,0) or \
                ...
                if proximity.get_is_45_concave_cusp_at_bottom(0,1):
                    ...
                    if proximity.get_is_bottom_left_corner_clipped_90_90(-1,1):
                        if proximity.get_is_45_pos_ceiling_at_top(0,2):
                            if proximity.get_is_45_pos_floor_at_right(-2,0):
                                return SubtileCorner.INT_90_90_CONCAVE_INT_45_FLOOR_45_CEILING
                            else:
                                if proximity.get_is_top_left_corner_clipped_90V_45(-1,0):
                                    return SubtileCorner.INT_90_90_CONCAVE_INT_INT_90V_45_CONCAVE_INT_45_H_SIDE
                        ...
                        # All indirect neighbors in the directions of this corner are present.
                        if proximity.get_is_45_pos_ceiling_at_left(0,2) or \
                                proximity.get_is_45_pos_ceiling_at_bottom(2,0) or \
                                proximity.get_is_45_pos_ceiling(1,1):
                            if proximity.get_is_45_pos_floor_at_bottom(-2,0) or \
                                    proximity.get_is_45_pos_floor_at_left(0,-2) or \
                                    proximity.get_is_45_pos_floor(-1,-1):
                                if proximity.get_is_bottom_right_corner_clipped_90H_45(0,1):
                                    if proximity.get_is_top_left_corner_clipped_90V_45(-1,0):
                                        return SubtileCorner.INT_INT_90H_45_CONCAVE_90V_45_CONCAVE
...
func get_target_bottom_right_corner(proximity: CellProximity) -> int:
    if !proximity.get_is_a_corner_match_subtile():
        ...
        if proximity.get_is_90_ceiling(0,1) or \
                proximity.get_is_90_ceiling(1,1) or \
                proximity.get_is_bottom_left_corner_clipped_90_90(0,1):
            if proximity.get_is_90_left_wall(1,0) or \
                    proximity.get_is_90_left_wall(1,1) or \
                    proximity.get_is_top_right_corner_clipped_90_90(1,0):
                ...
                if proximity.get_is_45_concave_cusp_at_right(1,0):
                    ...
                    if proximity.get_is_45_neg_ceiling_at_right(-1,1):
                        if proximity.get_is_45_neg_floor_at_left(1,-1):
                            ...
                            return SubtileCorner.INT_90H_INT_45_H_SIDE
                    elif proximity.get_is_45_neg_floor_at_left(1,-1) or \
                        proximity.get_is_45_concave_cusp_at_right(2,0):
                        return SubtileCorner.INT_90H_INT_45_V_SIDE
                    else:
                        return SubtileCorner.INT_90H
            ...
            if proximity.get_is_90_left_wall(1,0) or \
                ...
                if proximity.get_is_45_concave_cusp_at_bottom(0,1):
                    ...
                    if proximity.get_is_bottom_right_corner_clipped_90_90(1,1):
                        if proximity.get_is_45_neg_ceiling_at_top(0,2):
                            if proximity.get_is_45_neg_floor_at_left(2,0):
                                return SubtileCorner.INT_90_90_CONCAVE_INT_45_FLOOR_45_CEILING
                            else:
                                if proximity.get_is_top_right_corner_clipped_90V_45(1,0):
                                    return SubtileCorner.INT_90_90_CONCAVE_INT_INT_90V_45_CONCAVE_INT_45_H_SIDE
                        ...
                        # All indirect neighbors in the directions of this corner are present.
                        if proximity.get_is_45_neg_ceiling_at_right(0,2) or \
                                proximity.get_is_45_neg_ceiling_at_bottom(-2,0) or \
                                proximity.get_is_45_neg_ceiling(-1,1):
                            if proximity.get_is_45_neg_floor_at_bottom(2,0) or \
                                    proximity.get_is_45_neg_floor_at_right(0,-2) or \
                                    proximity.get_is_45_neg_floor(1,-1):
                                if proximity.get_is_bottom_left_corner_clipped_90H_45(0,1):
                                    if proximity.get_is_top_right_corner_clipped_90V_45(1,0):
                                        return SubtileCorner.INT_INT_90H_45_CONCAVE_90V_45_CONCAVE
